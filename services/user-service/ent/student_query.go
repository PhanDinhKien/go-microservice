...
func (_q *StudentQuery) QueryUser() *UserQuery {
...
func (_q *StudentQuery) WithUser(opts ...func(*UserQuery)) *StudentQuery {
	query := (&UserClient{config: _q.config}).Query()
...
//		GroupBy(student.FieldStudentCode).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Student.Query().
//		Select(student.FieldStudentCode).
//		Scan(ctx, &v)
...
func (_q *StudentQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Student, init func(*Student), assign func(*Student, *User)) error {
...
func (_q *StudentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(student.FieldUserID)
		}
	}
