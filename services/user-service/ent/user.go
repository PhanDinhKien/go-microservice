...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldPhone, user.FieldStatus:
...
func (_m *User) QueryStudents() *StudentQuery {
	return NewUserClient(_m.config).QueryStudents(_m)
}
